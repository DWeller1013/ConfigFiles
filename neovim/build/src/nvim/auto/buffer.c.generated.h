...
static int read_buffer(_Bool read_stdin, exarg_T *eap, int flags);
...
static int empty_curbuf(_Bool close_others, int forceit, int action);
...
static _Bool wininfo_other_tab_diff(WinInfo *wip) FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL;
static WinInfo *find_wininfo(buf_T *buf, _Bool need_options, _Bool skip_diff_buffer) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_PURE;
