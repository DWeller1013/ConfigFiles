...
static linenr_T setManualFold(pos_T pos, _Bool opening, _Bool recurse, int *donep);
static linenr_T setManualFoldWin(win_T *wp, linenr_T lnum, _Bool opening, _Bool recurse, int *donep);
...
static void deleteFoldMarkers(win_T *wp, fold_T *fp, _Bool recursive, linenr_T lnum_off);
...
static void foldclosed_both(typval_T *argvars, typval_T *rettv, _Bool end);
