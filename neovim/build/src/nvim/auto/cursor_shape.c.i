# 0 "/home/dweller/neovim/src/nvim/cursor_shape.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/dweller/neovim/src/nvim/cursor_shape.c"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stdbool.h" 1 3 4
# 2 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 3 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 4 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 6 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 7 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 8 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 9 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 10 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 7 "/home/dweller/neovim/src/nvim/ex_getln.h" 2
...
# 11 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 12 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 814 "/home/dweller/neovim/src/nvim/globals.h"
           skip_update_topline ;
# 13 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 14 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2
...
# 20 "/home/dweller/neovim/src/nvim/cursor_shape.c" 2





static const char e_digit_expected[] = "E548: Digit expected";


cursorentry_T shape_table[SHAPE_IDX_COUNT] = {


  { "normal", 0, 0, 0, 700, 400, 250, 0, 0, "n", 2 + 1 },
  { "visual", 0, 0, 0, 700, 400, 250, 0, 0, "v", 2 + 1 },
  { "insert", 0, 0, 0, 700, 400, 250, 0, 0, "i", 2 + 1 },
  { "replace", 0, 0, 0, 700, 400, 250, 0, 0, "r", 2 + 1 },
  { "cmdline_normal", 0, 0, 0, 700, 400, 250, 0, 0, "c", 2 + 1 },
  { "cmdline_insert", 0, 0, 0, 700, 400, 250, 0, 0, "ci", 2 + 1 },
  { "cmdline_replace", 0, 0, 0, 700, 400, 250, 0, 0, "cr", 2 + 1 },
  { "operator", 0, 0, 0, 700, 400, 250, 0, 0, "o", 2 + 1 },
  { "visual_select", 0, 0, 0, 700, 400, 250, 0, 0, "ve", 2 + 1 },
  { "cmdline_hover", 0, 0, 0, 0, 0, 0, 0, 0, "e", 1 },
  { "statusline_hover", 0, 0, 0, 0, 0, 0, 0, 0, "s", 1 },
  { "statusline_drag", 0, 0, 0, 0, 0, 0, 0, 0, "sd", 1 },
  { "vsep_hover", 0, 0, 0, 0, 0, 0, 0, 0, "vs", 1 },
  { "vsep_drag", 0, 0, 0, 0, 0, 0, 0, 0, "vd", 1 },
  { "more", 0, 0, 0, 0, 0, 0, 0, 0, "m", 1 },
  { "more_lastline", 0, 0, 0, 0, 0, 0, 0, 0, "ml", 1 },
  { "showmatch", 0, 0, 0, 100, 100, 100, 0, 0, "sm", 2 },
  { "terminal", 0, 0, 0, 0, 0, 0, 0, 0, "t", 2 },
};
...
Array mode_style_array(Arena *arena)
{
  ...
  for (int i = 0; i < SHAPE_IDX_COUNT; i++) {
    ...
    Dict dic = arena_dict(arena, 3 + ((cur->used_for & 2) ? 9 : 0));
    ...
    (*((all).items + ((all).size++)) = (((Object) { .type = kObjectTypeDict, .data.dict = dic })));
  }

  return all;
}
# 103 "/home/dweller/neovim/src/nvim/cursor_shape.c"
const char *parse_shape_opt(int what)
{
  char *p = 
# 105 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
           ((void *)0)
# 105 "/home/dweller/neovim/src/nvim/cursor_shape.c"
               ;
  int idx = 0;
  int len;
  
# 108 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
 _Bool 
# 108 "/home/dweller/neovim/src/nvim/cursor_shape.c"
      found_ve = 
# 108 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                 0
# 108 "/home/dweller/neovim/src/nvim/cursor_shape.c"
  ...
  for (int round = 1; round <= 2; round++) {
    if (round == 2 || *p_guicursor == '\000') {
      ...
      if (*p_guicursor == '\000') {
        ui_mode_info_set();
        return 
# 118 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
              ((void *)0)
# 118 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                  ;
      }
    }
    ...
    while (modep != 
# 123 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                   ((void *)0) 
# 123 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                        && *modep != '\000') {
      char *colonp = vim_strchr(modep, ':');
      char *commap = vim_strchr(modep, ',');

      if (colonp == 
# 127 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                   ((void *)0) 
# 127 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                        || (commap != 
# 127 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                                      ((void *)0) 
# 127 "/home/dweller/neovim/src/nvim/cursor_shape.c"
        ...
        if (all_idx < 0) {
          ...
          if (len == 1 && (((modep[0]) < 'A' || (modep[0]) > 'Z') ? (modep[0]) : (modep[0]) + ('a' - 'A')) == 'a') {
            ...
            if (len == 2 && modep[0] == 'v' && modep[1] == 'e') {
              found_ve = 
# 159 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                        1
# 159 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                            ;
            }
          }
          modep += len + 1;
...
# 191 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                                       0
# 191 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                                            , 0);
              if (len == 3) {
                if (n == 0) {
              ...
              if (commap == 
# 220 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0)
# 220 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                               ) {
                if (endp == 
# 221 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0)
# 221 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                               ) {
                  endp = p + strlen(p);
                }
              } else if (endp > commap || endp == 
# 224 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                                                 ((void *)0)
# 224 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                                                     ) {
                endp = commap;
              }
              char *slashp = vim_strchr(p, '/');
              if (slashp != 
# 228 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0) 
# 228 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                                && slashp < endp) {
              ...
              if (round == 2) {
                ...
                if (slashp != 
# 236 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                             ((void *)0) 
# 236 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                                  && slashp < endp) {
      ...
      modep = p;
      if (modep != 
# 250 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
                  ((void *)0) 
# 250 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                       && *modep == ',') {
        modep++;
      }
    }
  ...
  ui_mode_info_set();
  return 
# 273 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
        ((void *)0)
# 273 "/home/dweller/neovim/src/nvim/cursor_shape.c"
            ;
}
...
# 280 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
_Bool 
# 280 "/home/dweller/neovim/src/nvim/cursor_shape.c"
...
int cursor_mode_str2int(const char *mode)
{
  ...
  logmsg(3, 
# 299 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
 ((void *)0)
# 299 "/home/dweller/neovim/src/nvim/cursor_shape.c"
 , __func__, 299, 
# 299 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
 1
# 299 "/home/dweller/neovim/src/nvim/cursor_shape.c"
...
# 304 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
_Bool 
# 304 "/home/dweller/neovim/src/nvim/cursor_shape.c"
    cursor_mode_uses_syn_id(int syn_id)
  FUNC_ATTR_PURE
{
  if (*p_guicursor == '\000') {
    return 
# 308 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
          0
# 308 "/home/dweller/neovim/src/nvim/cursor_shape.c"
               ;
  }
  for (int mode_idx = 0; mode_idx < SHAPE_IDX_COUNT; mode_idx++) {
    if (shape_table[mode_idx].id == syn_id
      ...
      return 
# 313 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
            1
# 313 "/home/dweller/neovim/src/nvim/cursor_shape.c"
                ;
    }
  }
  return 
# 316 "/home/dweller/neovim/src/nvim/cursor_shape.c" 3 4
        0
# 316 "/home/dweller/neovim/src/nvim/cursor_shape.c"
             ;
}
