# 0 "/home/dweller/neovim/src/nvim/map.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/dweller/neovim/src/nvim/map.c"
...
# 9 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 10 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/build/cmake.config/auto/config.h" 1
       
# 12 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 5 "/home/dweller/neovim/src/nvim/map_defs.h" 2
...
# 6 "/home/dweller/neovim/src/nvim/map_defs.h" 2
...
# 13 "/home/dweller/neovim/src/nvim/map.c" 2
# 34 "/home/dweller/neovim/src/nvim/map.c"
...
static inline 
# 55 "/home/dweller/neovim/src/nvim/map.c" 3 4
             _Bool 
# 55 "/home/dweller/neovim/src/nvim/map.c"
                  equal_HlEntry(HlEntry ae1, HlEntry ae2)
{
...
static inline 
# 70 "/home/dweller/neovim/src/nvim/map.c" 3 4
             _Bool 
# 70 "/home/dweller/neovim/src/nvim/map.c"
                  equal_ColorKey(ColorKey ae1, ColorKey ae2)
{
  return memcmp(&ae1, &ae2, sizeof(ae1)) == 0;
}
# 82 "/home/dweller/neovim/src/nvim/map.c"
void mh_realloc(MapHash *h, uint32_t n_min_buckets)
{
  xfree(h->hash);
  uint32_t n_buckets = n_min_buckets < 16 ? 16 : n_min_buckets;
  (--(n_buckets), (n_buckets) |= (n_buckets)>>1, (n_buckets) |= (n_buckets)>>2, (n_buckets) |= (n_buckets)>>4, (n_buckets) |= (n_buckets)>>8, (n_buckets) |= (n_buckets)>>16, ++(n_buckets));

  h->hash = xcalloc(n_buckets, sizeof *h->hash);
  h->n_occupied = h->size = 0;
  h->n_buckets = n_buckets;
  h->upper_bound = (uint32_t)(h->n_buckets * 0.77 + 0.5);
}
...
# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_int(Set_int *set, int key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
{
  ...
  uint32_t i = k & mask;
  uint32_t last = i;
  uint32_t site = put ? last : 
# 29 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                              (4294967295U)
# 29 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                          ;
  while (!((h)->hash[i] == 0)) {
    if (((h)->hash[i] == 
# 31 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
       (4294967295U)
# 31 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
       )) {
      if (site == last) {
        site = i;
      }
    } else if (((set->keys[h->hash[i] - 1]) == (key))) {
      return i;
    }
    i = (i + (++step)) & mask;
    if (i == last) {
...
uint32_t mh_get_int(Set_int *set, int key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
          (4294967295U)
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                      ;
  }
  uint32_t idx = mh_find_bucket_int(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
  return (idx != 
# 56 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                (4294967295U)
# 56 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                            ) ? set->h.hash[idx] - 1 : 
# 56 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                       (4294967295U)
# 56 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
...
void mh_rehash_int(Set_int *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_int(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_int(Set_int *set, int key, MHPutStatus *new)
{
  MapHash *h = &set->h;
  ...
  uint32_t idx = mh_find_bucket_int(set, key, 
# 101 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    1
# 101 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                        );

  if (((uint32_t)((h)->hash[idx] + 1U) <= 1U)) {
    h->size++;
    if (((h)->hash[idx] == 0)) {
      h->n_occupied++;
    }
    ...
    if (pos >= h->keys_capacity) {
      h->keys_capacity = 
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                        (((
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                        h->keys_capacity * 2
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                        )>(
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(int));
...
uint32_t mh_delete_int(Set_int *set, int *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
          (4294967295U)
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                      ;
  }
  uint32_t idx = mh_find_bucket_int(set, *key, 
# 140 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                     0
# 140 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                          );
  if (idx != 
# 141 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
            (4294967295U)
# 141 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                        ) {
    uint32_t k = set->h.hash[idx] - 1;
    set->h.hash[idx] = 
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                      (4294967295U)
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                  ;
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_int(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
  ...
  return 
# 158 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
        (4294967295U)
# 158 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                    ;
}
# 105 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
int *map_ref_intint(Map_intint *map, int key, int **key_alloc)
{
  uint32_t k = mh_get_int(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
                      ) {
    return 
# 20 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          ((void *)0)
# 20 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
              ;
  }
  if (key_alloc) {
...
int *map_put_ref_intint(Map_intint *map, int key, int **key_alloc,
                                   
# 29 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
                                  _Bool 
# 29 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
                                       *new_item)
{
  MHPutStatus status;
  uint32_t k = mh_put_int(&map->set, key, &status);
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(int));
    }
    map->values[k] = value_init_int;
  }
  if (new_item) {
...
int map_del_intint(Map_intint *map, int key, int *key_alloc)
{
  int rv = value_init_int;
  uint32_t k = mh_delete_int(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
                      ) {
    return rv;
  }
...
# 107 "/home/dweller/neovim/src/nvim/map.c" 2


# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
ptr_t *map_ref_intptr_t(Map_intptr_t *map, int key, int **key_alloc)
{
  uint32_t k = mh_get_int(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
...
ptr_t *map_put_ref_intptr_t(Map_intptr_t *map, int key, int **key_alloc,
                                       ...
                                       *new_item)
{
  ...
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(ptr_t));
    }
    map->values[k] = value_init_ptr_t;
  }
  if (new_item) {
    *new_item = (status != kMHExisting);
  }
...
ptr_t map_del_intptr_t(Map_intptr_t *map, int key, int *key_alloc)
{
  ptr_t rv = value_init_ptr_t;
  uint32_t k = mh_delete_int(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
...
# 110 "/home/dweller/neovim/src/nvim/map.c" 2


# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
String *map_ref_intString(Map_intString *map, int key, int **key_alloc)
{
  uint32_t k = mh_get_int(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
...
String *map_put_ref_intString(Map_intString *map, int key, int **key_alloc,
                                       ...
                                       *new_item)
{
  ...
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(String));
    }
    map->values[k] = value_init_String;
  }
  if (new_item) {
    *new_item = (status != kMHExisting);
  }
...
String map_del_intString(Map_intString *map, int key, int *key_alloc)
{
  String rv = value_init_String;
  uint32_t k = mh_delete_int(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
...
# 113 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_ptr_t(Set_ptr_t *set, ptr_t key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
{
  ...
  uint32_t step = 0;
  uint32_t mask = h->n_buckets - 1;
  uint32_t k = (uint32_t)(((uint64_t)(key)) >> 33^((uint64_t)(key))^((uint64_t)(key)) << 11);
  uint32_t i = k & mask;
  uint32_t last = i;
  uint32_t site = put ? last : 
# 29 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 31 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    } else if ((((uint64_t)(set->keys[h->hash[i] - 1])) == ((uint64_t)(key)))) {
      return i;
    }
    i = (i + (++step)) & mask;
    if (i == last) {
...
uint32_t mh_get_ptr_t(Set_ptr_t *set, ptr_t key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
  ...
  uint32_t idx = mh_find_bucket_ptr_t(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
...
void mh_rehash_ptr_t(Set_ptr_t *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_ptr_t(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_ptr_t(Set_ptr_t *set, ptr_t key, MHPutStatus *new)
{
  MapHash *h = &set->h;
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(ptr_t));
      *new = kMHNewKeyRealloc;
    } else {
      *new = kMHNewKeyDidFit;
    }
    ...
    *new = kMHExisting;
    uint32_t pos = h->hash[idx] - 1;
    if (!(((uint64_t)(set->keys[pos])) == ((uint64_t)(key)))) {
      abort();
    }
    return pos;
  }
...
uint32_t mh_delete_ptr_t(Set_ptr_t *set, ptr_t *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_ptr_t(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
...
# 118 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
ptr_t *map_ref_ptr_tptr_t(Map_ptr_tptr_t *map, ptr_t key, ptr_t **key_alloc)
{
  uint32_t k = mh_get_ptr_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
ptr_t *map_put_ref_ptr_tptr_t(Map_ptr_tptr_t *map, ptr_t key, ptr_t **key_alloc,
...
{
  MHPutStatus status;
  uint32_t k = mh_put_ptr_t(&map->set, key, &status);
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(ptr_t));
    }
...
ptr_t map_del_ptr_tptr_t(Map_ptr_tptr_t *map, ptr_t key, ptr_t *key_alloc)
{
  ptr_t rv = value_init_ptr_t;
  uint32_t k = mh_delete_ptr_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
# 120 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_cstr_t(Set_cstr_t *set, cstr_t key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
...
# 31 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    } else if (strequal(set->keys[h->hash[i] - 1], key)) {
      return i;
    }
    i = (i + (++step)) & mask;
    if (i == last) {
...
uint32_t mh_get_cstr_t(Set_cstr_t *set, cstr_t key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
  ...
  uint32_t idx = mh_find_bucket_cstr_t(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
...
void mh_rehash_cstr_t(Set_cstr_t *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_cstr_t(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_cstr_t(Set_cstr_t *set, cstr_t key, MHPutStatus *new)
{
  MapHash *h = &set->h;
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(cstr_t));
      *new = kMHNewKeyRealloc;
    } else {
      *new = kMHNewKeyDidFit;
    }
...
uint32_t mh_delete_cstr_t(Set_cstr_t *set, cstr_t *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_cstr_t(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
...
# 125 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
ptr_t *map_ref_cstr_tptr_t(Map_cstr_tptr_t *map, cstr_t key, cstr_t **key_alloc)
{
  uint32_t k = mh_get_cstr_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
ptr_t *map_put_ref_cstr_tptr_t(Map_cstr_tptr_t *map, cstr_t key, cstr_t **key_alloc,
...
{
  MHPutStatus status;
  uint32_t k = mh_put_cstr_t(&map->set, key, &status);
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(ptr_t));
    }
...
ptr_t map_del_cstr_tptr_t(Map_cstr_tptr_t *map, cstr_t key, cstr_t *key_alloc)
{
  ptr_t rv = value_init_ptr_t;
  uint32_t k = mh_delete_cstr_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
# 127 "/home/dweller/neovim/src/nvim/map.c" 2


# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
int *map_ref_cstr_tint(Map_cstr_tint *map, cstr_t key, cstr_t **key_alloc)
{
  uint32_t k = mh_get_cstr_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
...
int *map_put_ref_cstr_tint(Map_cstr_tint *map, cstr_t key, cstr_t **key_alloc,
...
int map_del_cstr_tint(Map_cstr_tint *map, cstr_t key, cstr_t *key_alloc)
{
  int rv = value_init_int;
  uint32_t k = mh_delete_cstr_t(&map->set, &key);
  if (k == 
...
# 130 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_String(Set_String *set, String key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
...
# 31 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    } else if (equal_String(set->keys[h->hash[i] - 1], key)) {
      return i;
    }
    i = (i + (++step)) & mask;
    if (i == last) {
...
uint32_t mh_get_String(Set_String *set, String key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
  ...
  uint32_t idx = mh_find_bucket_String(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
...
void mh_rehash_String(Set_String *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_String(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_String(Set_String *set, String key, MHPutStatus *new)
{
  MapHash *h = &set->h;
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(String));
      *new = kMHNewKeyRealloc;
    } else {
      *new = kMHNewKeyDidFit;
    }
    ...
    *new = kMHExisting;
    uint32_t pos = h->hash[idx] - 1;
    if (!equal_String(set->keys[pos], key)) {
      abort();
    }
    return pos;
  }
...
uint32_t mh_delete_String(Set_String *set, String *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_String(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
...
# 135 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
int *map_ref_Stringint(Map_Stringint *map, String key, String **key_alloc)
{
  uint32_t k = mh_get_String(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
int *map_put_ref_Stringint(Map_Stringint *map, String key, String **key_alloc,
...
{
  MHPutStatus status;
  uint32_t k = mh_put_String(&map->set, key, &status);
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(int));
    }
...
int map_del_Stringint(Map_Stringint *map, String key, String *key_alloc)
{
  int rv = value_init_int;
  uint32_t k = mh_delete_String(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
# 137 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_uint32_t(Set_uint32_t *set, uint32_t key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
...
uint32_t mh_get_uint32_t(Set_uint32_t *set, uint32_t key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
  ...
  uint32_t idx = mh_find_bucket_uint32_t(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
...
void mh_rehash_uint32_t(Set_uint32_t *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_uint32_t(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_uint32_t(Set_uint32_t *set, uint32_t key, MHPutStatus *new)
{
  MapHash *h = &set->h;
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(uint32_t));
      *new = kMHNewKeyRealloc;
    } else {
      *new = kMHNewKeyDidFit;
    }
...
uint32_t mh_delete_uint32_t(Set_uint32_t *set, uint32_t *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_uint32_t(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
...
# 142 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
ptr_t *map_ref_uint32_tptr_t(Map_uint32_tptr_t *map, uint32_t key, uint32_t **key_alloc)
{
  uint32_t k = mh_get_uint32_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
ptr_t *map_put_ref_uint32_tptr_t(Map_uint32_tptr_t *map, uint32_t key, uint32_t **key_alloc,
...
{
  MHPutStatus status;
  uint32_t k = mh_put_uint32_t(&map->set, key, &status);
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(ptr_t));
    }
...
ptr_t map_del_uint32_tptr_t(Map_uint32_tptr_t *map, uint32_t key, uint32_t *key_alloc)
{
  ptr_t rv = value_init_ptr_t;
  uint32_t k = mh_delete_uint32_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
# 144 "/home/dweller/neovim/src/nvim/map.c" 2


# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
uint32_t *map_ref_uint32_tuint32_t(Map_uint32_tuint32_t *map, uint32_t key, uint32_t **key_alloc)
{
  uint32_t k = mh_get_uint32_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
...
uint32_t *map_put_ref_uint32_tuint32_t(Map_uint32_tuint32_t *map, uint32_t key, uint32_t **key_alloc,
                                       ...
                                       *new_item)
{
  ...
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(uint32_t));
    }
    map->values[k] = value_init_uint32_t;
  }
  if (new_item) {
    *new_item = (status != kMHExisting);
  }
...
uint32_t map_del_uint32_tuint32_t(Map_uint32_tuint32_t *map, uint32_t key, uint32_t *key_alloc)
{
  uint32_t rv = value_init_uint32_t;
  uint32_t k = mh_delete_uint32_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
...
# 147 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_uint64_t(Set_uint64_t *set, uint64_t key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
{
  ...
  uint32_t step = 0;
  uint32_t mask = h->n_buckets - 1;
  uint32_t k = (uint32_t)((key) >> 33^(key)^(key) << 11);
  uint32_t i = k & mask;
  uint32_t last = i;
  uint32_t site = put ? last : 
# 29 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
uint32_t mh_get_uint64_t(Set_uint64_t *set, uint64_t key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
  ...
  uint32_t idx = mh_find_bucket_uint64_t(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
...
void mh_rehash_uint64_t(Set_uint64_t *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_uint64_t(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_uint64_t(Set_uint64_t *set, uint64_t key, MHPutStatus *new)
{
  MapHash *h = &set->h;
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(uint64_t));
      *new = kMHNewKeyRealloc;
    } else {
      *new = kMHNewKeyDidFit;
    }
...
uint32_t mh_delete_uint64_t(Set_uint64_t *set, uint64_t *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_uint64_t(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
...
# 152 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
ptr_t *map_ref_uint64_tptr_t(Map_uint64_tptr_t *map, uint64_t key, uint64_t **key_alloc)
{
  uint32_t k = mh_get_uint64_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
ptr_t *map_put_ref_uint64_tptr_t(Map_uint64_tptr_t *map, uint64_t key, uint64_t **key_alloc,
...
{
  MHPutStatus status;
  uint32_t k = mh_put_uint64_t(&map->set, key, &status);
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(ptr_t));
    }
...
ptr_t map_del_uint64_tptr_t(Map_uint64_tptr_t *map, uint64_t key, uint64_t *key_alloc)
{
  ptr_t rv = value_init_ptr_t;
  uint32_t k = mh_delete_uint64_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
# 154 "/home/dweller/neovim/src/nvim/map.c" 2


# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
ssize_t *map_ref_uint64_tssize_t(Map_uint64_tssize_t *map, uint64_t key, uint64_t **key_alloc)
{
  uint32_t k = mh_get_uint64_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
...
ssize_t *map_put_ref_uint64_tssize_t(Map_uint64_tssize_t *map, uint64_t key, uint64_t **key_alloc,
                                       ...
                                       *new_item)
{
  ...
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(ssize_t));
    }
    map->values[k] = value_init_ssize_t;
  }
  if (new_item) {
    *new_item = (status != kMHExisting);
  }
...
ssize_t map_del_uint64_tssize_t(Map_uint64_tssize_t *map, uint64_t key, uint64_t *key_alloc)
{
  ssize_t rv = value_init_ssize_t;
  uint32_t k = mh_delete_uint64_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
...
# 157 "/home/dweller/neovim/src/nvim/map.c" 2


# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
uint64_t *map_ref_uint64_tuint64_t(Map_uint64_tuint64_t *map, uint64_t key, uint64_t **key_alloc)
{
  uint32_t k = mh_get_uint64_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
...
uint64_t *map_put_ref_uint64_tuint64_t(Map_uint64_tuint64_t *map, uint64_t key, uint64_t **key_alloc,
                                       ...
                                       *new_item)
{
  ...
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(uint64_t));
    }
    map->values[k] = value_init_uint64_t;
  }
  if (new_item) {
    *new_item = (status != kMHExisting);
  }
...
uint64_t map_del_uint64_tuint64_t(Map_uint64_tuint64_t *map, uint64_t key, uint64_t *key_alloc)
{
  uint64_t rv = value_init_uint64_t;
  uint32_t k = mh_delete_uint64_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
...
# 160 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_int64_t(Set_int64_t *set, int64_t key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
...
uint32_t mh_get_int64_t(Set_int64_t *set, int64_t key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
  ...
  uint32_t idx = mh_find_bucket_int64_t(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
...
void mh_rehash_int64_t(Set_int64_t *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_int64_t(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_int64_t(Set_int64_t *set, int64_t key, MHPutStatus *new)
{
  MapHash *h = &set->h;
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(int64_t));
      *new = kMHNewKeyRealloc;
    } else {
      *new = kMHNewKeyDidFit;
    }
...
uint32_t mh_delete_int64_t(Set_int64_t *set, int64_t *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_int64_t(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
...
# 165 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
ptr_t *map_ref_int64_tptr_t(Map_int64_tptr_t *map, int64_t key, int64_t **key_alloc)
{
  uint32_t k = mh_get_int64_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
ptr_t *map_put_ref_int64_tptr_t(Map_int64_tptr_t *map, int64_t key, int64_t **key_alloc,
...
{
  MHPutStatus status;
  uint32_t k = mh_put_int64_t(&map->set, key, &status);
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(ptr_t));
    }
...
ptr_t map_del_int64_tptr_t(Map_int64_tptr_t *map, int64_t key, int64_t *key_alloc)
{
  ptr_t rv = value_init_ptr_t;
  uint32_t k = mh_delete_int64_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
# 167 "/home/dweller/neovim/src/nvim/map.c" 2


# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
int64_t *map_ref_int64_tint64_t(Map_int64_tint64_t *map, int64_t key, int64_t **key_alloc)
{
  uint32_t k = mh_get_int64_t(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
...
int64_t *map_put_ref_int64_tint64_t(Map_int64_tint64_t *map, int64_t key, int64_t **key_alloc,
                                       ...
                                       *new_item)
{
  ...
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(int64_t));
    }
    map->values[k] = value_init_int64_t;
  }
  if (new_item) {
    *new_item = (status != kMHExisting);
  }
...
int64_t map_del_int64_tint64_t(Map_int64_tint64_t *map, int64_t key, int64_t *key_alloc)
{
  int64_t rv = value_init_int64_t;
  uint32_t k = mh_delete_int64_t(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
...
# 170 "/home/dweller/neovim/src/nvim/map.c" 2
...
# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_HlEntry(Set_HlEntry *set, HlEntry key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
...
# 31 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    } else if (equal_HlEntry(set->keys[h->hash[i] - 1], key)) {
      return i;
    }
    i = (i + (++step)) & mask;
    if (i == last) {
...
uint32_t mh_get_HlEntry(Set_HlEntry *set, HlEntry key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
  ...
  uint32_t idx = mh_find_bucket_HlEntry(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
...
void mh_rehash_HlEntry(Set_HlEntry *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_HlEntry(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_HlEntry(Set_HlEntry *set, HlEntry key, MHPutStatus *new)
{
  MapHash *h = &set->h;
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(HlEntry));
      *new = kMHNewKeyRealloc;
    } else {
      *new = kMHNewKeyDidFit;
    }
    ...
    *new = kMHExisting;
    uint32_t pos = h->hash[idx] - 1;
    if (!equal_HlEntry(set->keys[pos], key)) {
      abort();
    }
    return pos;
  }
...
uint32_t mh_delete_HlEntry(Set_HlEntry *set, HlEntry *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_HlEntry(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
...
# 175 "/home/dweller/neovim/src/nvim/map.c" 2



# 1 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 1
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_find_bucket_ColorKey(Set_ColorKey *set, ColorKey key, 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               _Bool 
# 21 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                    put)
...
# 31 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    } else if (equal_ColorKey(set->keys[h->hash[i] - 1], key)) {
      return i;
    }
    i = (i + (++step)) & mask;
    if (i == last) {
...
uint32_t mh_get_ColorKey(Set_ColorKey *set, ColorKey key)
{
  if (set->h.n_buckets == 0) {
    return 
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 53 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
  ...
  uint32_t idx = mh_find_bucket_ColorKey(set, key, 
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                    0
# 55 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                         );
...
void mh_rehash_ColorKey(Set_ColorKey *set)
{
  for (uint32_t k = 0; k < set->h.n_keys; k++) {
    uint32_t idx = mh_find_bucket_ColorKey(set, set->keys[k], 
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                               1
# 65 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                   );
...
# 83 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
uint32_t mh_put_ColorKey(Set_ColorKey *set, ColorKey key, MHPutStatus *new)
{
  MapHash *h = &set->h;
...
# 111 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                    ;
      set->keys = xrealloc(set->keys, h->keys_capacity * sizeof(ColorKey));
      *new = kMHNewKeyRealloc;
    } else {
      *new = kMHNewKeyDidFit;
    }
    ...
    *new = kMHExisting;
    uint32_t pos = h->hash[idx] - 1;
    if (!equal_ColorKey(set->keys[pos], key)) {
      abort();
    }
    return pos;
  }
...
uint32_t mh_delete_ColorKey(Set_ColorKey *set, ColorKey *key)
{
  if (set->h.size == 0) {
    return 
# 138 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
...
# 143 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
    ...
    *key = set->keys[k];
    set->h.size--;
    if (last != k) {
      uint32_t idx2 = mh_find_bucket_ColorKey(set, set->keys[last], 
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h" 3 4
                                                                     0
# 149 "/home/dweller/neovim/src/nvim/map_key_impl.c.h"
                                                                          );
...
# 179 "/home/dweller/neovim/src/nvim/map.c" 2

# 1 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 1
# 16 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
ColorItem *map_ref_ColorKeyColorItem(Map_ColorKeyColorItem *map, ColorKey key, ColorKey **key_alloc)
{
  uint32_t k = mh_get_ColorKey(&map->set, key);
  if (k == 
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 19 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
ColorItem *map_put_ref_ColorKeyColorItem(Map_ColorKeyColorItem *map, ColorKey key, ColorKey **key_alloc,
...
{
  MHPutStatus status;
  uint32_t k = mh_put_ColorKey(&map->set, key, &status);
  if (status != kMHExisting) {
    if (status == kMHNewKeyRealloc) {
      map->values = xrealloc(map->values, map->set.h.keys_capacity * sizeof(ColorItem));
    }
    map->values[k] = value_init_ColorItem;
  }
  if (new_item) {
    *new_item = (status != kMHExisting);
  }
...
ColorItem map_del_ColorKeyColorItem(Map_ColorKeyColorItem *map, ColorKey key, ColorKey *key_alloc)
{
  ColorItem rv = value_init_ColorItem;
  uint32_t k = mh_delete_ColorKey(&map->set, &key);
  if (k == 
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h" 3 4
          (4294967295U)
# 52 "/home/dweller/neovim/src/nvim/map_value_impl.c.h"
...
# 181 "/home/dweller/neovim/src/nvim/map.c" 2
...
{
  cstr_t key_alloc = 
# 189 "/home/dweller/neovim/src/nvim/map.c" 3 4
                    ((void *)0)
# 189 "/home/dweller/neovim/src/nvim/map.c"
                        ;
  ptr_t val = map_del_cstr_tptr_t(map, key, &key_alloc);
