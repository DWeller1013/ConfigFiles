# 0 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
...
# 2 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
# 3 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
# 4 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
# 5 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
# 6 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
# 8 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
# 9 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
# 10 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
# 11 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
# 10 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.h" 2
...
# 14 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 2
...
void mpack_str(String str, PackerBuffer *packer)
{
  ...
  if (len < 20) {
    *(*(&packer->ptr))++ = (char)(0xa0 | len);;
  } else if (len < 0xff) {
    *(*(&packer->ptr))++ = (char)(0xd9);;
    *(*(&packer->ptr))++ = (char)(len);;
  } else if (len < 0xffff) {
    *(*(&packer->ptr))++ = (char)(0xda);;
    mpack_w2(&packer->ptr, (uint32_t)len);
  } else if (len < 0xffffffff) {
    *(*(&packer->ptr))++ = (char)(0xdb);;
...
void mpack_bin(String str, PackerBuffer *packer)
{
  const size_t len = str.size;
  if (len < 0xff) {
    *(*(&packer->ptr))++ = (char)(0xc4);;
    *(*(&packer->ptr))++ = (char)(len);;
  } else if (len < 0xffff) {
    *(*(&packer->ptr))++ = (char)(0xc5);;
    mpack_w2(&packer->ptr, (uint32_t)len);
  } else if (len < 0xffffffff) {
    *(*(&packer->ptr))++ = (char)(0xc6);;
    mpack_w4(&packer->ptr, (uint32_t)len);
  } else {
    abort();
  }
...
void mpack_raw(const char *data, size_t len, PackerBuffer *packer)
{
  ...
  while (pos < len) {
    ...
    size_t to_copy = 
# 123 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
                    (((
# 123 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
                    len - pos
# 123 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
                    )<(
# 123 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
...
{
  if (len == 1) {
    *(*(&packer->ptr))++ = (char)(0xd4);;
  } else if (len == 2) {
    *(*(&packer->ptr))++ = (char)(0xd5);;
  } else if (len <= 0xff) {
    *(*(&packer->ptr))++ = (char)(0xc7);;
  } else if (len < 0xffff) {
    *(*(&packer->ptr))++ = (char)(0xc8);;
    mpack_w2(&packer->ptr, (uint32_t)len);
  } else if (len < 0xffffffff) {
    *(*(&packer->ptr))++ = (char)(0xc9);;
    mpack_w4(&packer->ptr, (uint32_t)len);
  } else {
    abort();
  }
  *(*(&packer->ptr))++ = (char)(type);;
  mpack_raw(buf, len, packer);
}

void mpack_handle(ObjectType type, handle_T handle, PackerBuffer *packer)
{
  char exttype = (char)(type - kObjectTypeBuffer);
  if (-0x1f <= handle && handle <= 0x7f) {
    *(*(&packer->ptr))++ = (char)(0xd4);;
    *(*(&packer->ptr))++ = (char)(exttype);;
    *(*(&packer->ptr))++ = (char)((char)handle);;
  } else {

    
# 165 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
   ((void) sizeof ((
# 165 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
   handle >= 0
# 165 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
...
# 165 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
   "handle >= 0"
# 165 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
   , "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c", 165, __extension__ __PRETTY_FUNCTION__); }))
# 165 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
                      ;
...
{
  mpack_object_inner(obj, 
# 182 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
                         ((void *)0)
# 182 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
                             , 0, packer);
}
...
void mpack_object_array(Array arr, PackerBuffer *packer)
{
  ...
  if (arr.size > 0) {
    Object container = ((Object) { .type = kObjectTypeArray, .data.array = arr });
    mpack_object_inner(&arr.items[0], arr.size > 1 ? &container : 
# 190 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
                                                                 ((void *)0)
# 190 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
                                                                     , 1, packer);
  }
}
  ...
  FUNC_ATTR_NONNULL_ARG(1, 4)
{
  ...
  struct { size_t size; size_t capacity; ContainerStackItem *items; ContainerStackItem init_array[2]; } stack = { .size = 0, .capacity = 0, .items = 
# 205 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
                                                ((void *)0) 
# 205 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
                                                };
  ...
  while (
# 208 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
        1
# 208 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
            ) {
    mpack_check_buffer(packer);
    switch (current->type) {
    ...
    if (!container) {
      if (((stack).size)) {
        ContainerStackItem it = ((stack).items[--(stack).size]);
    ...
    if (container->type == kObjectTypeArray) {
      ...
      if (container_idx >= arr.size) {
        container = 
# 279 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
                   ((void *)0)
# 279 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
                       ;
      }
    } else {
      ...
      if (container_idx >= dict.size) {
        container = 
# 288 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
                   ((void *)0)
# 288 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
                       ;
      }
    }
  }
  do { if ((stack).items != (stack).init_array) { do { void **ptr_ = (void **)&((stack).items); xfree(*ptr_); *ptr_ = 
# 292 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c" 3 4
 ((void *)0)
# 292 "/home/dweller/neovim/src/nvim/msgpack_rpc/packer.c"
