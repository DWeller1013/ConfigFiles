// IWYU pragma: private, include "nvim/ex_cmds2.h"
...
DLLEXPORT int autowrite(buf_T *buf, _Bool forceit);
...
DLLEXPORT _Bool can_abandon(buf_T *buf, _Bool forceit);
DLLEXPORT _Bool check_changed_any(_Bool hidden, _Bool unload);
DLLEXPORT int check_fname(void);
DLLEXPORT int buf_write_all(buf_T *buf, _Bool forceit);
