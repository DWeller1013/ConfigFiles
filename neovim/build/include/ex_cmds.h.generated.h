// IWYU pragma: private, include "nvim/ex_cmds.h"
...
#  endif
#endif
DLLEXPORT void do_ascii(exarg_T *eap);
...
DLLEXPORT char *make_filter_cmd(char *cmd, char *itmp, char *otmp, _Bool do_in);
DLLEXPORT void append_redir(char *const buf, const size_t buflen, const char *const opt, const char *const fname);
DLLEXPORT void print_line_no_prefix(linenr_T lnum, _Bool use_number, _Bool list);
DLLEXPORT void print_line(linenr_T lnum, _Bool use_number, _Bool list, _Bool first);
...
DLLEXPORT int check_overwrite(exarg_T *eap, buf_T *buf, char *fname, char *ffname, _Bool other);
DLLEXPORT void ex_wnext(exarg_T *eap);
DLLEXPORT void do_wqall(exarg_T *eap);
DLLEXPORT _Bool not_writing(void);
DLLEXPORT int getfile(int fnum, char *ffname_arg, char *sfname_arg, _Bool setpm, linenr_T lnum, _Bool forceit);
DLLEXPORT _Bool set_swapcommand(char *command, linenr_T newlnum);
...
DLLEXPORT int ex_substitute_preview(exarg_T *eap, int cmdpreview_ns, handle_T cmdpreview_bufnr);
