// IWYU pragma: private, include "nvim/context.h"
...
DLLEXPORT Dict ctx_to_dict(Context *ctx, Arena *arena) FUNC_ATTR_NONNULL_ALL;
DLLEXPORT int ctx_from_dict(Dict dict, Context *ctx, Error *err) FUNC_ATTR_NONNULL_ALL;
#include "nvim/func_attr.h"
