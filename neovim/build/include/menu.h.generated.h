// IWYU pragma: private, include "nvim/menu.h"
...
DLLEXPORT int get_menu_cmd_modes(const char *cmd, _Bool forceit, int *noremap, _Bool *unmenu);
...
DLLEXPORT _Bool menu_is_separator(char *name);
