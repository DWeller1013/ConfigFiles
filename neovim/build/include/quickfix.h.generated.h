// IWYU pragma: private, include "nvim/quickfix.h"
...
DLLEXPORT void qf_resize_stack(int n);
DLLEXPORT void ll_resize_stack(win_T *wp, int n);
DLLEXPORT void qf_init_stack(void);
...
DLLEXPORT _Bool qf_mark_adjust(buf_T *buf, win_T *wp, linenr_T line1, linenr_T line2, linenr_T amount, linenr_T amount_after);
...
DLLEXPORT const char *did_set_quickfixtextfunc(optset_T *args FUNC_ATTR_UNUSED);
