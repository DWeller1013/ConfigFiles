// IWYU pragma: private, include "nvim/match.h"
...
DLLEXPORT int update_search_hl(win_T *wp, linenr_T lnum, colnr_T col, char **line, match_T *search_hl, int *has_match_conc, int *match_conc, _Bool lcs_eol_todo, _Bool *on_last_col, _Bool *search_attr_from_match);
DLLEXPORT _Bool get_prevcol_hl_flag(win_T *wp, match_T *search_hl, colnr_T curcol);
DLLEXPORT void get_search_match_hl(win_T *wp, match_T *search_hl, colnr_T col, int *char_attr);
