// IWYU pragma: private, include "nvim/msgpack_rpc/server.h"
...
DLLEXPORT char *server_address_new(const char *name) FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_RET;
