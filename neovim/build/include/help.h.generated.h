// IWYU pragma: private, include "nvim/help.h"
...
DLLEXPORT int help_heuristic(char *matched_string, int offset, _Bool wrong_case) FUNC_ATTR_PURE;
...
DLLEXPORT void get_local_additions(void);
