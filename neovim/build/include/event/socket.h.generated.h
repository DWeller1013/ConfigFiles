// IWYU pragma: private, include "nvim/event/socket.h"
...
DLLEXPORT int socket_watcher_accept(SocketWatcher *watcher, RStream *stream) FUNC_ATTR_NONNULL_ARG(1) FUNC_ATTR_NONNULL_ARG(2);
DLLEXPORT void socket_watcher_close(SocketWatcher *watcher, socket_close_cb cb) FUNC_ATTR_NONNULL_ARG(1);
DLLEXPORT _Bool socket_connect(Loop *loop, RStream *stream, _Bool is_tcp, const char *address, int timeout, const char **error);
#include "nvim/func_attr.h"
