...
DLLEXPORT int u_savecommon(buf_T *buf, linenr_T top, linenr_T bot, linenr_T newbot, _Bool reload);
...
DLLEXPORT void undo_time(int step, _Bool sec, _Bool file, _Bool absolute);
...
DLLEXPORT void u_saveline(buf_T *buf, linenr_T lnum);
